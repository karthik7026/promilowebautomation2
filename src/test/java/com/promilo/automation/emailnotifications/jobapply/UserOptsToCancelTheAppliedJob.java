...
Locator developerJob = page.locator("//span[text()='Google']").nth(1);
developerJob.click();
test.info("Clicked on Developer job listing");

Locator developerJob1 = page.locator("//span[text()='Google']").nth(1);
developerJob.click();
...
page.locator("//button[text()='Submit']").nth(1).click();
        ...
        page.locator("//div[@class='modal-content']").textContent();
       ...
       System.out.println(page1.locator("//span[contains(text(),'Hi')]").textContent()); 
     System.out.println(page1.locator("//p[contains(text(),'We wanted to inform you that,')]").textContent());  
     System.out.println(page1.locator("//p[text()='Explore all similar ']").textContent());
