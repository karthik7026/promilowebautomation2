...
public class WhenUserAcceptsRecruitersRescheduleRequest extends Baseclass {
    ...
    public void applyForJobAsRegisteredUser(Page page, String inputvalue, String password, String name,
        ...
        // Select today's date dynamically
        page3.locator("span.flatpickr-day[aria-current='date']").click();
        ...
        String modalText = page3
                .locator("//p[text()='Your meeting has been successfully Rescheduled.']")
                .textContent();
        System.out.println("Modal text: " + modalText);

        page3.navigate("https://mailosaur.com/app/servers/ofuk8kzb/messages/inbox");

        page3.locator("//input[@placeholder='Enter your email address']")
                .fill("karthiku7026@gmail.com");
        page3.locator("//button[text()='Continue']").click();

        page3.locator("//input[@placeholder='Enter your password']").fill("Karthik@88");
        page3.locator("//button[text()='Log in']").click();
        ...
        page3.locator(
                "//p[contains(text(),'Reschedule Request Accepted for Developer')]")
                .first().isVisible();
        page3.locator("//span[contains(text(),'Greetings')]").textContent();
        page3.locator("//p[contains(text(),'Great news! Your confirmation')]").isVisible();
        page3.locator("//td[@style='padding-left: 10px']").textContent();
        page3.locator("//span[contains(text(),'My Meetings')]").click();
    }
}
